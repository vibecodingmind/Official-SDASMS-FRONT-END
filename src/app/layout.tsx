  ...
  return (
    <html lang="en">
      <head>
        ...
        {/* Structured data - ld+json scripts don't cause hydration issues */}
        <script
      ...
      >
        ...
        {/* Theme detection script — runs before page paint to avoid flash */}
        <Script
          id="sdasms-theme-init"
          strategy="beforeInteractive"
          dangerouslySetInnerHTML={{
            __html: `(function(){try{var t=localStorage.getItem('sdasms-theme');if(t==='dark'){document.documentElement.classList.add('dark')}else if(t==='light'){document.documentElement.classList.remove('dark')}else if(window.matchMedia('(prefers-color-scheme: dark)').matches){document.documentElement.classList.add('dark')}}catch(e){}})();`,
          }}
        />

        {/* Tawk.to chat — deferred loading */}
        <Script
          id="sdasms-tawk"
          strategy="lazyOnload"
          dangerouslySetInnerHTML={{
            __html: `var Tawk_API=Tawk_API||{},Tawk_LoadStart=new Date();(function(){function loadTawk(){try{var s1=document.createElement("script"),s0=document.getElementsByTagName("script")[0];s1.async=true;s1.src='https://embed.tawk.to/67726ec3af5bfec1dbe484a7/1igbg1bae';s1.charset='UTF-8';s1.setAttribute('crossorigin','*');if(s0&&s0.parentNode){s0.parentNode.insertBefore(s1,s0)}else{document.head.appendChild(s1)}}catch(e){}}if('requestIdleCallback' in window){requestIdleCallback(function(){setTimeout(loadTawk,3000)})}else{setTimeout(loadTawk,3000)}})();`,
          }}
        />

        {/* Suppress React 19 hydration "true" console error */}
        <Script
          id="sdasms-error-suppress"
          strategy="beforeInteractive"
          dangerouslySetInnerHTML={{
            __html: `(function(){var oe=console.error;console.error=function(){if(arguments.length===1&&(arguments[0]===true||typeof arguments[0]==='boolean'))return;return oe.apply(this,arguments)};var ow=console.warn;console.warn=function(){if(arguments.length===1&&(arguments[0]===true||typeof arguments[0]==='boolean'))return;return ow.apply(this,arguments)};})();`,
          }}
        />
      </body>
    </html>
