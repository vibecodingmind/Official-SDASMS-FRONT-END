      ...
      <main className="flex-1">
        ...
        <section className="py-12 bg-[#F6F6F6] dark:bg-[#1A0A2E]">
          <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            <FadeInWhenVisible>
              <div className="bg-white dark:bg-[#0D0B1A] rounded-2xl p-6 sm:p-8 border border-gray-100 dark:border-white/10 shadow-lg text-center">
                <div className="w-14 h-14 rounded-2xl flex items-center justify-center mx-auto mb-4" style={{ backgroundColor: `${PRODUCT_COLOR}10` }}>
                  <MessageSquare className="w-7 h-7" style={{ color: PRODUCT_COLOR }} />
                </div>
                <h3 className="text-lg font-bold text-black dark:text-white mb-2">Ready to Get Started?</h3>
                <p className="text-sm text-[#7F7F7F] dark:text-white/50 mb-5">Sign up today and start sending SMS messages to your congregation instantly.</p>
                <a href="/get-started" className="inline-flex items-center gap-2 bg-[#D72444] hover:bg-[#E03355] text-white font-bold text-sm px-6 py-3 rounded-full transition-all duration-300">
                  Get Started
